...
def render_altcoin_analysis(view_mode: Optional[str] = None):
    ...
    try:
        st.subheader("Market Analysis & Overview")
        ...
        # Market Analysis Section with two columns
    ...
    try:
        ...
        fig = go.Figure(data=[
            go.Bar(
                ...
                textposition='auto',
                marker_color=[THEME['accent2'] if x > 0 else THEME['secondary'] for x in sector_metrics['change_24h']]
            )
        ])
